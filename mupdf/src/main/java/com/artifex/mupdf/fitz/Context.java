...
public class Context
{
	...
	private static MupdfLibLoader libLoader;

	private static native int initNative();

	public static void setLibLoader(MupdfLibLoader libLoader) {
		Context.libLoader = libLoader;
	}
	...
	public interface MupdfLibLoader {
		String load();
	}
}
